...
import cn.google.android.exoplayer2.audio.AudioCapabilities;
import cn.google.android.exoplayer2.audio.AudioProcessor;
import cn.google.android.exoplayer2.audio.AudioRendererEventListener;
import cn.google.android.exoplayer2.audio.MediaCodecAudioRenderer;
import cn.google.android.exoplayer2.drm.DrmSessionManager;
import cn.google.android.exoplayer2.drm.FrameworkMediaCrypto;
import cn.google.android.exoplayer2.mediacodec.MediaCodecSelector;
import cn.google.android.exoplayer2.metadata.MetadataOutput;
import cn.google.android.exoplayer2.metadata.MetadataRenderer;
import cn.google.android.exoplayer2.text.TextOutput;
import cn.google.android.exoplayer2.text.TextRenderer;
import cn.google.android.exoplayer2.trackselection.TrackSelector;
import cn.google.android.exoplayer2.video.MediaCodecVideoRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              AudioRendererEventListener.class,
