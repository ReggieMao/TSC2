...
import cn.google.android.exoplayer2.source.CompositeSequenceableLoaderFactory;
import cn.google.android.exoplayer2.source.EmptySampleStream;
import cn.google.android.exoplayer2.source.MediaPeriod;
import cn.google.android.exoplayer2.source.SampleStream;
import cn.google.android.exoplayer2.source.SequenceableLoader;
import cn.google.android.exoplayer2.source.TrackGroup;
import cn.google.android.exoplayer2.source.TrackGroupArray;
import cn.google.android.exoplayer2.source.chunk.ChunkSampleStream;
...
import cn.google.android.exoplayer2.source.dash.manifest.Descriptor;
import cn.google.android.exoplayer2.source.dash.manifest.EventStream;
import cn.google.android.exoplayer2.source.dash.manifest.Period;
...
import cn.google.android.exoplayer2.upstream.Allocator;
...
import cn.google.android.exoplayer2.source.MediaSourceEventListener;
...
/* package */ final class DashMediaPeriod
  ...
  private final IdentityHashMap<ChunkSampleStream<DashChunkSource>, PlayerEmsgHandler.PlayerTrackEmsgHandler>
  ...
  public synchronized void onSampleStreamReleased(ChunkSampleStream<DashChunkSource> stream) {
    PlayerEmsgHandler.PlayerTrackEmsgHandler trackEmsgHandler = trackEmsgHandlerBySampleStream.remove(stream);
    ...
    for (int i = 0; i < selections.length; i++) {
      if (streams[i] instanceof EmptySampleStream || streams[i] instanceof ChunkSampleStream.EmbeddedSampleStream) {
        ...
        if (primaryStreamIndex == C.INDEX_UNSET) {
          ...
          mayRetainStream =
              (streams[i] instanceof ChunkSampleStream.EmbeddedSampleStream)
                  && ((ChunkSampleStream.EmbeddedSampleStream) streams[i]).parent == streams[primaryStreamIndex];
        }
        if (!mayRetainStream) {
