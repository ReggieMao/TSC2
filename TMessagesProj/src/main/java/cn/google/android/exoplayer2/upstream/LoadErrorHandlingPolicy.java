 ...
 */
package cn.google.android.exoplayer2.upstream;
 ...
 * #getMinimumLoadableRetryCount(Loader.Loadable)}.
 *
 * @param <T> The type of the object being loaded.
 */
public interface LoadErrorHandlingPolicy<T extends Loader.Loadable> {
  ...
  LoadErrorHandlingPolicy<Loader.Loadable> DEFAULT =
      new LoadErrorHandlingPolicy<Loader.Loadable>() {

        /**
         * Blacklists resources whose load error was an {@link HttpDataSource.InvalidResponseCodeException} with
         * response code HTTP 404 or 410. The duration of the blacklisting is {@link
         * ChunkedTrackBlacklistUtil#DEFAULT_TRACK_BLACKLIST_MS}.
         */
        @Override
        public long getBlacklistDurationMsFor(
                Loader.Loadable loadable, long loadDurationMs, IOException exception, int errorCount) {
        ...
        @Override
        public int getMinimumLoadableRetryCount(Loader.Loadable loadable) {
          return DEFAULT_MIN_LOADABLE_RETRY_COUNT;
        }
      };

  /** Returns {@link #DEFAULT}. */
  static <U extends Loader.Loadable> LoadErrorHandlingPolicy<U> getDefault() {
