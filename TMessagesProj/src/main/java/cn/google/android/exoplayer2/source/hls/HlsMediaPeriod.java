...
public final class HlsMediaPeriod implements MediaPeriod, HlsSampleStreamWrapper.Callback,
  ...
  private void buildAndPrepareSampleStreamWrappers(long positionUs) {
    ...
    for (int i = 0; i < audioRenditions.size(); i++) {
      ...
      HlsSampleStreamWrapper sampleStreamWrapper =
          buildSampleStreamWrapper(
              C.TRACK_TYPE_AUDIO,
              new HlsMasterPlaylist.HlsUrl[] {audioRendition},
              null,
    ...
    for (int i = 0; i < subtitleRenditions.size(); i++) {
      ...
      HlsSampleStreamWrapper sampleStreamWrapper =
          buildSampleStreamWrapper(
              C.TRACK_TYPE_TEXT, new HlsMasterPlaylist.HlsUrl[] {url}, null, Collections.emptyList(), positionUs);
      sampleStreamWrappers[currentWrapperIndex++] = sampleStreamWrapper;
      sampleStreamWrapper.prepareWithMasterPlaylistInfo(
  ...
  private HlsSampleStreamWrapper buildSampleStreamWrapper(int trackType, HlsMasterPlaylist.HlsUrl[] variants,
