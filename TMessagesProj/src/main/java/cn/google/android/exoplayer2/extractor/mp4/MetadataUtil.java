...
import cn.google.android.exoplayer2.metadata.id3.ApicFrame;
import cn.google.android.exoplayer2.metadata.id3.CommentFrame;
import cn.google.android.exoplayer2.metadata.id3.Id3Frame;
import cn.google.android.exoplayer2.metadata.id3.InternalFrame;
import cn.google.android.exoplayer2.metadata.id3.TextInformationFrame;
...
/* package */ final class MetadataUtil {
  ...
  Metadata.Entry parseIlstElement(ParsableByteArray ilst) {
  ...
  TextInformationFrame parseTextAttribute(
  ...
  private static @Nullable
  ApicFrame parseCoverArt(ParsableByteArray data) {
    int atomSize = data.readInt();
    int atomType = data.readInt();
    if (atomType == Atom.TYPE_data) {
