...
import cn.google.android.exoplayer2.source.dash.manifest.DashManifestParser;
import cn.google.android.exoplayer2.source.dash.manifest.UtcTimingElement;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  /* package */ Loader.LoadErrorAction onManifestLoadError(
  ...
  /* package */ Loader.LoadErrorAction onUtcTimestampLoadError(
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      cn.google.android.exoplayer2.source.dash.manifest.Period period =
