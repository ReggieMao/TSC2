...
import com.ebei.ui.Cells.TextCheckCell;
import com.ebei.ui.Cells.TextDetailSettingsCell;
import com.ebei.ui.Cells.TextInfoCell;
...
//        ActionBarMenuItem item = menu.addItem(0, 0);
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("NotificationsAndSounds", R.string.logout), true);
                    } else if (position == backgroundRow) {
...
//                        textCell.setTextAndValue(value, LocaleController.getString("TapToChangePhone", R.string.TapToChangePhone), true);
                        textCell.setTextAndValue(UserObject.getUserName(user), LocaleController.getString("TapToChangePhone", R.string.EditName), true);
                    } else if (position == usernameRow) {
                        TLRPC.User user = UserConfig.getInstance(currentAccount).getCurrentUser();
                        String value;
