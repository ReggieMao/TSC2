...
import com.ebei.ui.Components.IdenticonDrawable;
import com.ebei.ui.Components.ImageUpdater;
        ...
        if (playProfileAnimation && allowProfileAnimation) {
            ...
            if (menu.getItem(10) == null) {
                if (animatingItem == null) {
                    animatingItem = menu.addItem(10, R.drawable.ic_ab_other1);
                }
            }
            if (isOpen) {
    ...
    private void updateProfileData() {
        ...
        if (user_id != 0) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                Drawable leftIcon = currentEncryptedChat != null ? Theme.chat_lockIconDrawable1 : null;
        ...
        if (user_id != 0) {
            if (UserConfig.getInstance(currentAccount).getClientUserId() != user_id) {
                ...
                if (ContactsController.getInstance(currentAccount).contactsDict.get(user_id) == null) {
                    ...
                    item = menu.addItem(10, R.drawable.ic_ab_other1);
                    if (isBot) {
                        if (!user.bot_nochats) {
            ...
            if (chat_id > 0) {
                ...
                if (ChatObject.isChannel(chat)) {
                    ...
                    if (!chat.admins_enabled || chat.creator || chat.admin) {
                        editItem = menu.addItem(edit_name, R.drawable.group_edit_profile1);
                    }
                    item = menu.addItem(10, R.drawable.ic_ab_other1);
