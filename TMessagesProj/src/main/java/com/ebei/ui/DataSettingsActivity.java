...
//                        headerCell.setText(LocaleController.getString("Proxy", R.string.Proxy));
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == storageUsageRow || position == useLessDataForCallsRow || position == mobileUsageRow || position == roamingUsageRow || position == wifiUsageRow ||
        ...
        public int getItemViewType(int position) {
            if (position == mediaDownloadSection2Row || position == usageSection2Row || position == callsSection2Row) {
                return 0;
            } else if (position == mediaDownloadSectionRow || position == streamSectionRow || position == callsSectionRow || position == usageSectionRow) {
                return 2;
