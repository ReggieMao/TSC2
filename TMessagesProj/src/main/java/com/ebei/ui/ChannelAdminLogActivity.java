...
import com.ebei.ui.Components.AdminLogFilterAlert;
...
//        actionBar.setBackButtonDrawable(new BackDrawable(false));
    ...
    public ThemeDescription[] getThemeDescriptions() {
        return new ThemeDescription[]{
                ...
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInDrawableRedPag, Theme.chat_msgInMediaDrawableRedPag}, null, Theme.key_chat_inBubbleRedPag),
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInDrawableTransfer, Theme.chat_msgInMediaDrawableTransfer}, null, Theme.key_chat_inBubbleTransfer),
