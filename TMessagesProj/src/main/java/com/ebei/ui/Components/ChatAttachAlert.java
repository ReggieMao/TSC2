...
import com.ebei.ui.Cells.PhotoAttachCameraCell;
import com.ebei.ui.Cells.PhotoAttachPhotoCell;
...
//                LocaleController.getString("ChatVideo", R.string.ChatVideo),
                LocaleController.getString("ChatTransfer", R.string.ChatTransfer),
//                LocaleController.getString("AttachMusic", R.string.AttachMusic),
                LocaleController.getString("RedEnvelope", R.string.RedEnvelope),
