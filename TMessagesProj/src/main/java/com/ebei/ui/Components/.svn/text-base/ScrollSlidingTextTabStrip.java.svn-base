...
//        int prevColor = Theme.getColor(Theme.key_actionBarDefaultSubtitle);
        int newColor = getResources().getColor(R.color.title);
        int prevColor = getResources().getColor(R.color.textGray);
...
//        tab.setTextColor(Theme.getColor(currentPosition == position ? Theme.key_actionBarDefaultTitle : Theme.key_actionBarDefaultSubtitle));
        tab.setTextColor(currentPosition == position ? getResources().getColor(R.color.title) : getResources().getColor(R.color.textGray));
