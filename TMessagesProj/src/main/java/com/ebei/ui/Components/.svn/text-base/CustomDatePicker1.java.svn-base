...
/**
 * Created by MaoLJ on 2018/11/26.
 * 自定义月份选择器
 */

public class CustomDatePicker1 {
    ...
    private TextView tv_select, month_text, day_text, hour_text, minute_text;

    public CustomDatePicker1(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    public void showSpecificTime(boolean show) {
        if (canAccess) {
            if (show) {
                ...
                disScrollUnit(SCROLL_TYPE.MONTH, SCROLL_TYPE.DAY, SCROLL_TYPE.HOUR, SCROLL_TYPE.MINUTE);
