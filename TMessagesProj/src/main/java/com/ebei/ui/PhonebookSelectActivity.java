...
import com.ebei.ui.Adapters.PhonebookAdapter;
import com.ebei.ui.Adapters.PhonebookSearchAdapter;
...
public class PhonebookSelectActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        LaunchActivity mBaseActivity = (LaunchActivity) getParentActivity();
...
//        actionBar.setBackButtonImage(R.drawable.ic_ab_back);
        ...
        searchListViewAdapter = new PhonebookSearchAdapter(context, mBaseActivity.mNeed) {
            @Override
        ...
        listViewAdapter = new PhonebookAdapter(context, mBaseActivity.mNeed) {
            @Override
