...
import com.ebei.tsc.StatsController;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 3: {
                    ...
                    String all = LocaleController.getInstance().formatterStats.format(StatsController.getInstance(currentAccount).getResetStatsDate(currentType));
                    String year = all.substring(7, 11);
                    String month = all.substring(0, 3);
                    switch (month) {
                        case "Jan":
                            month = "1";
                            break;
                    ...
                    String day = all.substring(4, 6);
                    String need = year + "年" + month + "月" + day + "日" + all.substring(12, 18);
                    cell.setText(LocaleController.formatString("NetworkUsageSince", R.string.NetworkUsageSince, need));
                    break;
                }
                default:
                    break;
