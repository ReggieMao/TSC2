...
import com.ebei.ui.ActionBar.ActionBarPopupWindow;
...
import com.ebei.ui.Cells.SharedAudioCell;
import com.ebei.ui.Cells.SharedDocumentCell;
import com.ebei.ui.Cells.SharedLinkCell;
import com.ebei.ui.Cells.SharedMediaSectionCell;
import com.ebei.ui.Cells.SharedPhotoVideoCell;
...
import com.ebei.ui.Components.ScrollSlidingTextTabStrip;
    ...
    private class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < sharedMediaData[3].sections.size()) {
                ...
                String date = LocaleController.getInstance().formatterMonthYear.format((long) messageObject.messageOwner.date * 1000).toUpperCase();
                String month = getMonth(date.substring(0, date.indexOf(" ")));
                date = date.substring(date.indexOf(" ") + 1, date.length()) + "年" + month;
                ((GraySectionCell) view).setText(date);
            }
            return view;
        }
            ...
            if (holder.getItemViewType() != 2) {
                ...
                switch (holder.getItemViewType()) {
                    case 0: {
                        ...
                        String month = getMonth(date.substring(0, date.indexOf(" ")));
                        date = date.substring(date.indexOf(" ") + 1, date.length()) + "年" + month;
                        ((GraySectionCell) holder.itemView).setText(date);
                        break;
                    }
                    case 1: {
    ...
    private class SharedPhotoVideoAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < sharedMediaData[0].sections.size()) {
                ...
                String month = getMonth(date.substring(0, date.indexOf(" ")));
                date = date.substring(date.indexOf(" ") + 1, date.length()) + "年" + month;
                ((SharedMediaSectionCell) view).setText(date);
            }
            return view;
        }
            ...
            if (holder.getItemViewType() != 2) {
                ...
                switch (holder.getItemViewType()) {
                    case 0: {
                        ...
                        String month = getMonth(date.substring(0, date.indexOf(" ")));
                        date = date.substring(date.indexOf(" ") + 1, date.length()) + "年" + month;
                        ((SharedMediaSectionCell) holder.itemView).setText(date);
                        break;
                    }
                    case 1: {
