...
import com.ebei.pojo.Red;
import com.ebei.pojo.RedBag2;
import com.ebei.pojo.Transfer;
...
import com.ebei.tsc.BuildConfig;
...
import com.ebei.tsc.DownloadController;
import com.ebei.tsc.Emoji;
import com.ebei.tsc.EmojiSuggestion;
import com.ebei.tsc.FileLoader;
import com.ebei.tsc.FileLog;
import com.ebei.tsc.ImageReceiver;
import com.ebei.tsc.LocaleController;
import com.ebei.tsc.MediaController;
import com.ebei.tsc.MessageObject;
import com.ebei.tsc.MessagesController;
import com.ebei.tsc.MessagesStorage;
import com.ebei.tsc.NotificationCenter;
import com.ebei.tsc.NotificationsController;
import com.ebei.tsc.R;
import com.ebei.tsc.SecretChatHelper;
import com.ebei.tsc.SendMessagesHelper;
...
import com.ebei.tsc.VideoEditedInfo;
import com.ebei.tsc.browser.Browser;
import com.ebei.tsc.support.SparseLongArray;
import com.ebei.tsc.support.widget.GridLayoutManager;
import com.ebei.tsc.support.widget.GridLayoutManagerFixed;
...
import com.ebei.ui.ActionBar.ActionBarLayout;
...
import com.ebei.ui.ActionBar.SimpleTextView;
import com.ebei.ui.ActionBar.Theme;
import com.ebei.ui.ActionBar.ThemeDescription;
import com.ebei.ui.Adapters.MentionsAdapter;
import com.ebei.ui.Adapters.StickersAdapter;
import com.ebei.ui.Cells.BotHelpCell;
import com.ebei.ui.Cells.BotSwitchCell;
import com.ebei.ui.Cells.ChatActionCell;
import com.ebei.ui.Cells.ChatLoadingCell;
import com.ebei.ui.Cells.ChatMessageCell;
import com.ebei.ui.Cells.ChatUnreadCell;
import com.ebei.ui.Cells.CheckBoxCell;
import com.ebei.ui.Cells.ContextLinkCell;
import com.ebei.ui.Cells.MentionCell;
import com.ebei.ui.Cells.StickerCell;
...
import com.ebei.ui.Components.ChatAttachAlert;
import com.ebei.ui.Components.ChatAvatarContainer;
import com.ebei.ui.Components.ChatBigEmptyView;
import com.ebei.ui.Components.CombinedDrawable;
import com.ebei.ui.Components.CorrectlyMeasuringTextView;
import com.ebei.ui.Components.EmbedBottomSheet;
import com.ebei.ui.Components.EmojiView;
import com.ebei.ui.Components.ExtendedGridLayoutManager;
import com.ebei.ui.Components.FragmentContextView;
import com.ebei.ui.Components.InstantCameraView;
import com.ebei.ui.Components.LayoutHelper;
import com.ebei.ui.Components.NumberTextView;
import com.ebei.ui.Components.PipRoundVideoView;
import com.ebei.ui.Components.RadialProgressView;
import com.ebei.ui.Components.RecyclerListView;
import com.ebei.ui.Components.ShareAlert;
import com.ebei.ui.Components.Size;
import com.ebei.ui.Components.SizeNotifierFrameLayout;
import com.ebei.ui.Components.StickersAlert;
import com.ebei.ui.Components.TypefaceSpan;
import com.ebei.ui.Components.URLSpanBotCommand;
import com.ebei.ui.Components.URLSpanMono;
import com.ebei.ui.Components.URLSpanNoUnderline;
import com.ebei.ui.Components.URLSpanReplacement;
import com.ebei.ui.Components.URLSpanUserMention;
...
import cn.google.android.exoplayer2.ui.AspectRatioFrameLayout;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, LocationActivity.LocationActivityDelegate {
    ...
    private boolean hasSendRedPacket = false;
    private boolean hasSendTransfer = false;
        ...
        public boolean onItemClick(View view, int position, float x, float y) {
            ...
            if (!actionBar.isActionModeShowed()) {
                if (view instanceof ChatActionCell) {
                    if ((((ChatActionCell) view).getMessageObject().messageText.toString()).endsWith("领取了红包")) {
                        return true;
                    } else {
                ...
                if (view instanceof ChatMessageCell) {
                    if (!Util.isRedPac(((ChatMessageCell) view).getMessageObject().messageText.toString()) &&
                            !Util.isTransfer(((ChatMessageCell) view).getMessageObject().messageText.toString()))
    ...
    RecyclerListView.OnItemClickListenerExtended onItemClickListener = new RecyclerListView.OnItemClickListenerExtended() {
        ...
        public void onItemClick(View view, int position, float x, float y) {
            ...
            if (view instanceof ChatMessageCell) {
                if (!Util.isRedPac(((ChatMessageCell) view).getMessageObject().messageText.toString()) &&
                ...
                } else if (Util.isRedPac(((ChatMessageCell) view).getMessageObject().messageText.toString())) {
                    mCurrentMessage = ((ChatMessageCell) view).getMessageObject().messageText.toString();
                    // 点击红包消息前先判断用户是否已经登录钱包
                    UserPreference.putString(UserPreference.CURRENT_CLICK_RED, mCurrentMessage);
                    int conversationType;
                    if (ChatObject.isMegagroup(currentChat)) {
                        conversationType = 0;
                    } else {
                        if (null != currentUser) {
                            if (currentUser.id == UserConfig.getInstance(currentAccount).getClientUserId() ||
                                    currentUser.id == 333000 || currentUser.id == 777000 ||
                                    currentUser.bot ||
                                    currentUser.self) {
                                if (UserPreference.getString(UserPreference.IS_GROUP, "").equals("yes")) {
                                    conversationType = 0;
                                } else {
                                    conversationType = -1;
                                }
                    ...
                    if (!ChatObject.isMegagroup(currentChat) && ChatObject.isChannel(currentChat)) {
                        if (UserPreference.getString(UserPreference.IS_GROUP, "").equals("yes")) {
                            conversationType = 0;
                        } else {
                            conversationType = -1;
                    ...
                    UserPreference.putInt(UserPreference.CURRENT_CHAT_ID, conversationType == 0 ? currentChat.id : UserPreference.getInt(UserPreference.CURRENT_USER_ID, 0));
                    UserPreference.putInt(UserPreference.HAD_RECEIVE_RED, 0);
                    UserPreference.putInt(UserPreference.HAD_SHOW_RED_DIALOG, 0);
                    String sign = Constants.SALT_CIPHER + "loginAccount=" + mobile + "&submitTime=" + Util.getNowTime() + Constants.SALT_CIPHER;
                    sign = Util.encrypt(sign);
                    TSCApi.getInstance().checkLoginAccount(3, mobile, sign, Util.getNowTime());
                }
            }
        }
    };
    ...
    public boolean onFragmentCreate() {
        ...
        int mCurrentUid = currentUser == null ? 0 : currentUser.id;
        UserPreference.putInt(UserPreference.CURRENT_USER_ID, mCurrentUid);
        return true;
    }
...
//            actionBar.setBackButtonDrawable(new BackDrawable(false));
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(final int id) {
                if (id == -1) {
                    ...
                    UserPreference.putInt(UserPreference.DIALOGS_TAB_SHOW, 2);
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), (dialogInterface, i) -> {
                        if (id != clear_history) {
                            ...
                            UserPreference.putInt(UserPreference.GROUP_TAB_SHOW, 1);
                            finishFragment();
                        } else {
        ...
        if (currentEncryptedChat == null && !isBroadcast) {
            searchItem = menu.addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
                ...
                public void onSearchCollapse() {
                    ...
                    searchItem.getSearchField().setTextColor(getParentActivity().getResources().getColor(R.color.title));
                    searchItem.getSearchField().setCursorColor(getParentActivity().getResources().getColor(R.color.title));
                    searchItem.getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
                    searchItem.getSearchField().setHintTextColor(getParentActivity().getResources().getColor(R.color.textGray1));
            ...
            private void processTouchEvent(MotionEvent e) {
                if (e.getAction() == MotionEvent.ACTION_DOWN && !startedTracking && !maybeStartTracking) {
                    ...
                    if (view instanceof ChatMessageCell) {
                        ...
                        if (!Util.isRedPac(message.messageText.toString()) && !Util.isTransfer(message.messageText.toString()) && !Util.isRedReceive(message.messageText.toString())) {
            ...
            mentionListView.setOnItemClickListener(mentionsOnItemClickListener = (view, position) -> {
                ...
                if (object instanceof TLRPC.User) {
                    if (searchingForUser && searchContainer.getVisibility() == View.VISIBLE) {
                        ...
                        spannable.setSpan(new ForegroundColorSpan(Theme.getColor(Theme.key_player_button)), 0, from.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        ...
                        TLRPC.User user1 = (TLRPC.User) object;
                        if (user1 != null) {
                            if (user1.username != null) {
                                chatActivityEnterView.replaceWithText(start, len, "@" + user1.username + " ", false);
                            } else {
                                String name = UserObject.getFirstName(user1, false);
                                Spannable spannable = new SpannableString(name + " ");
                                spannable.setSpan(new URLSpanUserMention("" + user1.id, 1), 0, spannable.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        if (currentChat != null && (!ChatObject.isChannel(currentChat) || currentChat.megagroup)) {
            ...
            searchUserButton.setOnClickListener(view -> {
                ...
                String from = LocaleController.getString("SearchFrom", R.string.SearchFrom);
                Spannable spannable = new SpannableString(from);
                spannable.setSpan(new ForegroundColorSpan(Theme.getColor(Theme.key_player_button)), 0, from.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                searchItem.setSearchFieldCaption(spannable);
    ...
    private void initData() {
        mBaseActivity.rxManage.on(Event.SEND_RED_PACKET, new Action1<Red>() {
            @Override
            public void call(Red o) {
                if (!hasSendRedPacket) {
                    int chatOrUserId = 0;
                    if (currentUser != null)
                        chatOrUserId = currentUser.id;
                    else if (currentChat != null)
                        chatOrUserId = currentChat.id;
                    if (o.getChaOrUserId() == chatOrUserId) {
                        if (UserPreference.getInt(UserPreference.HAD_SEND_RED, 0) == 0) {
                            UserPreference.putInt(UserPreference.HAD_SEND_RED, 1);
                            chatActivityEnterView.sendRedPacket(o.getRedPagId(), o.getRedPagDescribe());
                            hasSendRedPacket = true;
                        }
                    }
                }
            }
        ...
        mBaseActivity.rxManage.on(Event.SEND_TRANSFER, new Action1<Transfer>() {
            @Override
            public void call(Transfer o) {
                if (!hasSendTransfer) {
                    int chatOrUserId = 0;
                    if (currentUser != null)
                        chatOrUserId = currentUser.id;
                        ...
                        chatOrUserId = currentChat.id;
                    if (o.getUserId().equals(chatOrUserId + "")) {
                        if (UserPreference.getInt(UserPreference.HAD_SEND_TRANSFER, 0) == 0) {
                            UserPreference.putInt(UserPreference.HAD_SEND_TRANSFER, 1);
                            chatActivityEnterView.sendTransfer(o.getAmount(), o.getCoinName());
                            hasSendTransfer = true;
                        }
                    }
                }
            }
        ...
        mBaseActivity.rxManage.on(Event.HAD_RECEIVE_RED, new Action1() {
            @Override
            public void call(Object o) {
                ...
                if (currentUser != null)
                    ...
                    chatOrUserId = currentChat.id;
                if (UserPreference.getInt(UserPreference.CURRENT_CHAT_ID, 0) == chatOrUserId) {
                    if (UserPreference.getInt(UserPreference.HAD_RECEIVE_RED, 0) == 0) {
                        UserPreference.putInt(UserPreference.HAD_RECEIVE_RED, 1);
                        TLRPC.User user = UserConfig.getInstance(currentAccount).getCurrentUser();
                        String name = UserObject.getUserName(user);
                        chatActivityEnterView.sendRedReceive(name);
                    }
                }
            }
        });

        mBaseActivity.rxManage.on(Event.RECEIVE_REDBAG, new Action1<RedBag2>() {
            @Override
            public void call(RedBag2 o) {
                int chatOrUserId = 0;
                if (currentUser != null)
                    chatOrUserId = currentUser.id;
                else if (currentChat != null)
                    chatOrUserId = currentChat.id;
                if (UserPreference.getInt(UserPreference.CURRENT_CHAT_ID, 0) == chatOrUserId) {
                    if (!Util.isEmpty(mCurrentMessage) && mCurrentMessage.equals(UserPreference.getString(UserPreference.CURRENT_CLICK_RED, ""))) {
                        String coinName = "";
                        ...
                        DialogUtil.openRedPagMsgDialog(getParentActivity(), o.getRedBag().getOpenId(), Util.eliminateZero(Double.parseDouble(Util.getScientificCountingMethodAfterData(Double.parseDouble(o.getReceiveAmout()), 6))) + coinName, new DialogUtil.OnResultListener0() {
                            @Override
                            public void onOK() {
                                Intent intent = new Intent(getParentActivity(), RedPacketReceiveActivity.class);
                                intent.putExtra(RedPacketReceiveActivity.RED_ID, mCurrentMessage.split("[$]")[1]);
                                intent.putExtra(RedPacketReceiveActivity.RED_CONTENT, mCurrentMessage.split("[$]")[2].substring(0, mCurrentMessage.split("[$]")[2].indexOf("}")));
        ...
        mBaseActivity.rxManage.on(Event.RED_NOTHING, new Action1<RedBag2>() {
            @Override
            public void call(RedBag2 o) {
                int chatOrUserId = 0;
                if (currentUser != null)
                ...
                if (UserPreference.getInt(UserPreference.CURRENT_CHAT_ID, 0) == chatOrUserId) {
                    if (!Util.isEmpty(mCurrentMessage) && mCurrentMessage.equals(UserPreference.getString(UserPreference.CURRENT_CLICK_RED, ""))) {
                        DialogUtil.openRedPagMsgDialog(getParentActivity(), o.getRedBag().getOpenId(), getParentActivity().getString(R.string.red_nothing), new DialogUtil.OnResultListener0() {
                            @Override
                            public void onOK() {
                                Intent intent = new Intent(getParentActivity(), RedPacketReceiveActivity.class);
                                intent.putExtra(RedPacketReceiveActivity.RED_ID, mCurrentMessage.split("[$]")[1]);
        ...
        mBaseActivity.rxManage.on(Event.TRY_AGAIN_LATER, new Action1<String>() {
            @Override
            public void call(String o) {
                ToastUtil.toast(getParentActivity(), o);
            }
        });

        mBaseActivity.rxManage.on(Event.PAY_PWD_ERROR, new Action1<String>() {
            @Override
            public void call(String o) {
                ToastUtil.toast(getParentActivity(), o);
            }
        ...
        mBaseActivity.rxManage.on(Event.CHECK_ACCOUNT2, new Action1<String>() {
            @Override
            public void call(String o) {
                if (o.equals("用户名已存在")) {
                    if (Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                        DialogUtil.transactionDialog(getParentActivity(), new DialogUtil.OnResultListener2() {
                            @Override
                            public void onOk(String... params) {
                                ...
                                sign = Util.encrypt(sign);
                                TSCApi.getInstance().userLogin(9, mobile, Util.encrypt(params[0]), sign, Util.getNowTime());
                            }

                            @Override
                            public void onForget() {
                                getParentActivity().startActivity(new Intent(getParentActivity(), UpdatePayPwdActivity.class));
                            }
                        });
                    } else {
                        hasSendRedPacket = false;
                        Intent intent = new Intent(mBaseActivity, SendRedPacketActivity.class);
                        intent.putExtra(SendRedPacketActivity.RED_PACKET_TYPE, mConversationType);
                        intent.putExtra(SendRedPacketActivity.CHAT_OR_USER_ID, mConversationType == 0 ? currentChat.id : UserPreference.getInt(UserPreference.CURRENT_USER_ID, 0));
                        if (mConversationType == 0 || mConversationType == 1)
                            intent.putExtra(SendRedPacketActivity.GROUP_MEMBER_NUM, currentChat.participants_count);
                        mBaseActivity.startActivityForResult(intent, 1001);
                    }
                } else if (o.equals("用户名不存在")) {
                    DialogUtil.setPayPwdDialog(getParentActivity(), new DialogUtil.OnResultListener0() {
                        @Override
                        public void onOK() {
                            Intent intent = new Intent(getParentActivity(), PayPwd1Activity.class);
                            intent.putExtra(PayPwd1Activity.MOBILE, mobile);
                            intent.putExtra(PayPwd1Activity.WHERE, 8);
                            getParentActivity().startActivity(intent);
                        }
                    });
                }
        ...
        mBaseActivity.rxManage.on(Event.CHECK_ACCOUNT4, new Action1<String>() {
            @Override
            public void call(String o) {
                if (o.equals("用户名已存在")) {
                    if (Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                        DialogUtil.transactionDialog(getParentActivity(), new DialogUtil.OnResultListener2() {
                            ...
                            public void onOk(String... params) {
                                ...
                                String sign = Constants.SALT_CIPHER + "loginAccount=" + mobile + "&password=" + Util.encrypt(params[0]) + "&submitTime=" + Util.getNowTime() + Constants.SALT_CIPHER;
                                sign = Util.encrypt(sign);
                                TSCApi.getInstance().userLogin(12, mobile, Util.encrypt(params[0]), sign, Util.getNowTime());
                            }
                        ...
                        hasSendTransfer = false;
                        Intent intent = new Intent(mBaseActivity, TransferActivity.class);
                        intent.putExtra(TransferActivity.UID, UserPreference.getInt(UserPreference.CURRENT_USER_ID, 0) + "");
                        mBaseActivity.startActivityForResult(intent, 1001);
                    }
                } else if (o.equals("用户名不存在")) {
                    DialogUtil.setPayPwdDialog(getParentActivity(), new DialogUtil.OnResultListener0() {
        ...
        mBaseActivity.rxManage.on(Event.CHECK_ACCOUNT3, new Action1<String>() {
            @Override
            public void call(String o) {
                if (o.equals("用户名已存在")) {
                    if (Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                        DialogUtil.transactionDialog(getParentActivity(), new DialogUtil.OnResultListener2() {
                            ...
                            public void onOk(String... params) {
                                ...
                                String sign = Constants.SALT_CIPHER + "loginAccount=" + mobile + "&password=" + Util.encrypt(params[0]) + "&submitTime=" + Util.getNowTime() + Constants.SALT_CIPHER;
                                sign = Util.encrypt(sign);
                                TSCApi.getInstance().userLogin(10, mobile, Util.encrypt(params[0]), sign, Util.getNowTime());
                            }
                        ...
                        if (!Util.isEmpty(mCurrentMessage) && mCurrentMessage.equals(UserPreference.getString(UserPreference.CURRENT_CLICK_RED, ""))) {
                            String[] arrar = mCurrentMessage.split("[$]");
                            String redPagId = arrar[1];
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "redbagId=" + redPagId + "&submitTime=" + Util.getNowTime() + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().receiveRedbag(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, redPagId);
                        }
                    }
                } else if (o.equals("用户名不存在")) {
                    DialogUtil.setPayPwdDialog(getParentActivity(), new DialogUtil.OnResultListener0() {
                        ...
                        public void onOK() {
                            Intent intent = new Intent(getParentActivity(), PayPwd1Activity.class);
                            intent.putExtra(PayPwd1Activity.MOBILE, mobile);
                            intent.putExtra(PayPwd1Activity.WHERE, 11);
                            getParentActivity().startActivity(intent);
                        }
                    });
                }
        ...
        mBaseActivity.rxManage.on(Event.LOGIN_PWD8, new Action1<Login>() {
            @Override
            public void call(Login o) {
                ToastUtil.toast(getParentActivity(), getParentActivity().getString(R.string.validate_success));
                ...
                String signA = UserPreference.getString(UserPreference.SECRET, "") + "audienceId=" + JPushInterface.getRegistrationID(getParentActivity()) + "&submitTime=" +
                        Util.getNowTime() + UserPreference.getString(UserPreference.SECRET, "");
                signA = Util.encrypt(signA);
                TSCApi.getInstance().saveId(signA, Util.getNowTime(), UserPreference.getString(UserPreference.SESSION_ID, ""), JPushInterface.getRegistrationID(getParentActivity()));
        ...
        mBaseActivity.rxManage.on(Event.LOGIN_PWD11, new Action1<Login>() {
            @Override
            public void call(Login o) {
                ToastUtil.toast(getParentActivity(), getParentActivity().getString(R.string.validate_success));
                UserPreference.putString(UserPreference.SESSION_ID, o.getSessionId());
        ...
        mBaseActivity.rxManage.on(Event.LOGIN_PWD9, new Action1<Login>() {
            @Override
            public void call(Login o) {
                ToastUtil.toast(getParentActivity(), getParentActivity().getString(R.string.validate_success));
                UserPreference.putString(UserPreference.SESSION_ID, o.getSessionId());
                ...
                if (!Util.isEmpty(mCurrentMessage) && mCurrentMessage.equals(UserPreference.getString(UserPreference.CURRENT_CLICK_RED, ""))) {
                    String[] arrar = mCurrentMessage.split("[$]");
                    String redPagId = arrar[1];
                    String signB = UserPreference.getString(UserPreference.SECRET, "") + "redbagId=" + redPagId + "&submitTime=" + Util.getNowTime() + UserPreference.getString(UserPreference.SECRET, "");
                    signB = Util.encrypt(signB);
                    TSCApi.getInstance().receiveRedbag(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), signB, redPagId);
                }
            }
        });
    }
    ...
    private void initStickers() {
        ...
        stickersListView.setOnItemClickListener(stickersOnItemClickListener = (view, position) -> {
            ...
            if (document instanceof TLRPC.TL_document) {
                ...
                UserPreference.putInt(UserPreference.SEND_MESSAGE_COUNT, UserPreference.getInt(UserPreference.SEND_MESSAGE_COUNT, 0) + 1);
                switch (UserPreference.getInt(UserPreference.SEND_MESSAGE_COUNT, 0)) {
                    case 5:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=5&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 5);
                        }
                        break;
                    case 10:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=10&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 10);
                        }
                        break;
                    case 15:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=15&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 15);
                        }
                        break;
                    case 20:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=20&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 20);
                        }
                        break;
                    case 25:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=25&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 25);
                        }
                        break;
                    case 30:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=30&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 30);
                        }
                        break;
                    case 40:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=40&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 40);
                        }
                        break;
                    case 50:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=50&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 50);
                        }
                        break;
                    case 60:
                        if (!Util.isEmpty(UserPreference.getString(UserPreference.SESSION_ID, ""))) {
                            String sign = UserPreference.getString(UserPreference.SECRET, "") + "chatNum=60&submitTime=" + Util.getNowTime() + "&type=2" + UserPreference.getString(UserPreference.SECRET, "");
                            sign = Util.encrypt(sign);
                            TSCApi.getInstance().addTValue(UserPreference.getString(UserPreference.SESSION_ID, ""), Util.getNowTime(), sign, 2, 60);
                        }
                        break;
                }
            }
    ...
    private void processSelectedAttach(int which) {
        if (which == attach_photo) {// 相机
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            CharSequence[] items;
            items = new CharSequence[]{LocaleController.getString("CameraPhoto", R.string.CameraPhoto), LocaleController.getString("CameraVideo", R.string.CameraVideo)};
            ...
            showDialog(builder.create());
        } else if (which == attach_gallery) {// 相册
            ...
            presentFragment(fragment);
        } else if (which == attach_video) {// 转账
            UserPreference.putInt(UserPreference.HAD_IN_TRANSFER, 0);
            UserPreference.putInt(UserPreference.HAD_SEND_TRANSFER, 0);
            int type1;
            if (ChatObject.isMegagroup(currentChat)) {
                type1 = 0;
            } else {
            ...
            if (type1 != 2) {
                ToastUtil.toast(getParentActivity(), getParentActivity().getString(R.string.can_not_send1));
            } else {
                String sign = Constants.SALT_CIPHER + "loginAccount=" + mobile + "&submitTime=" + Util.getNowTime() + Constants.SALT_CIPHER;
                sign = Util.encrypt(sign);
                TSCApi.getInstance().checkLoginAccount(4, mobile, sign, Util.getNowTime());
            }
        } else if (which == attach_location) {// 位置
            ...
            presentFragment(fragment);
        } else if (which == attach_document) {// 文件
            if (Build.VERSION.SDK_INT >= 23 && getParentActivity().checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                getParentActivity().requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 4);
                return;
            }
...
//            });
//            presentFragment(fragment);
            UserPreference.putInt(UserPreference.HAD_IN_RED, 0);
            UserPreference.putInt(UserPreference.HAD_SEND_RED, 0);
            if (ChatObject.isMegagroup(currentChat)) {
                mConversationType = 0;
            } else {
                if (null != currentUser) {
            ...
            if (mConversationType == -1) {
                ToastUtil.toast(getParentActivity(), getParentActivity().getString(R.string.can_not_send));
            } else {
                String sign = Constants.SALT_CIPHER + "loginAccount=" + mobile + "&submitTime=" + Util.getNowTime() + Constants.SALT_CIPHER;
                sign = Util.encrypt(sign);
                TSCApi.getInstance().checkLoginAccount(2, mobile, sign, Util.getNowTime());
            }
        } else if (which == attach_contact) {// 联系人
...
//            actionBar.setBackButtonDrawable(!value ? new BackDrawable(false) : null);
            actionBar.setBackButtonDrawable(!value ? getParentActivity().getResources().getDrawable(R.mipmap.back) : null);
...
//                actionBar.setBackButtonDrawable(new BackDrawable(parentLayout == null || parentLayout.fragmentsStack.isEmpty() || parentLayout.fragmentsStack.get(0) == ChatActivity.this || parentLayout.fragmentsStack.size() == 1));
    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
                ...
                chatMessageCell.setDelegate(new ChatMessageCell.ChatMessageCellDelegate() {
                    ...
                    public void didPressedUrl(MessageObject messageObject, final CharacterStyle url, boolean longPress) {
                        ...
                        if (url instanceof URLSpanMono) {
                            ...
                            if (messageObject.type == 0 && (!Util.isRedPac(messageObject.messageText.toString()) && !Util.isTransfer(messageObject.messageText.toString()) && !Util.isRedReceive(messageObject.messageText.toString()))) {
                                if (longPress) {
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                com.ebei.ui.Components.Rect rect = instantCameraView.getCameraRect();
        ...
        public int getItemViewType(int position) {
            if (position >= messagesStartRow && position < messagesEndRow) {
                if (messages.get(position - messagesStartRow).messageTransfer.toString().endsWith("领取了红包"))
                    return 1;
                else
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        return new ThemeDescription[]{
                ...
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class, BotHelpCell.class}, null, new Drawable[]{Theme.chat_msgInDrawableRedPag, Theme.chat_msgInMediaDrawableRedPag}, null, Theme.key_chat_inBubbleRedPag),
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class, BotHelpCell.class}, null, new Drawable[]{Theme.chat_msgInDrawableTransfer, Theme.chat_msgInMediaDrawableTransfer}, null, Theme.key_chat_inBubbleTransfer),
                ...
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInSelectedDrawableRedPag, Theme.chat_msgInMediaSelectedDrawableRedPag}, null, Theme.key_chat_inBubbleSelectedRedPag),
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInSelectedDrawableTransfer, Theme.chat_msgInMediaSelectedDrawableTransfer}, null, Theme.key_chat_inBubbleSelectedTransfer),
                ...
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutDrawableRedPag, Theme.chat_msgOutMediaDrawableRedPag}, null, Theme.key_chat_outBubbleRedPag),
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutDrawableTransfer, Theme.chat_msgOutMediaDrawableTransfer}, null, Theme.key_chat_outBubbleTransfer),
                ...
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutSelectedDrawableRedPag, Theme.chat_msgOutMediaSelectedDrawableRedPag}, null, Theme.key_chat_outBubbleSelectedRedPag),
                new ThemeDescription(chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutSelectedDrawableTransfer, Theme.chat_msgOutMediaSelectedDrawableTransfer}, null, Theme.key_chat_outBubbleSelectedTransfer),
