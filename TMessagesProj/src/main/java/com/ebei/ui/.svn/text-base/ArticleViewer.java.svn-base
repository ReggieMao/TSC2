...
import com.ebei.ui.ActionBar.BackDrawable;
...
import com.ebei.ui.Components.ContextProgressView;
...
import com.ebei.ui.Components.Scroller;
import com.ebei.ui.Components.SeekBar;
import com.ebei.ui.Components.ShareAlert;
import com.ebei.ui.Components.TextPaintSpan;
import com.ebei.ui.Components.TextPaintUrlSpan;
import com.ebei.ui.Components.TypefaceSpan;
import com.ebei.ui.Components.VideoPlayer;
import com.ebei.ui.Components.WebPlayerView;
    ...
    private class BlockAuthorDateCell extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (currentBlock != null) {
                if (lastCreatedWidth != width) {
                    CharSequence text;
                    CharSequence author = getText(currentBlock.author, currentBlock.author, currentBlock);
