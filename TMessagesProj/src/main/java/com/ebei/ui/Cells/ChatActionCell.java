...
public class ChatActionCell extends BaseCell {
    ...
    private void createLayout(CharSequence text, int width) {
        ...
        if (text.toString().startsWith("January")) {
            text = "1月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("February")) {
            text = "2月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("March")) {
            text = "3月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("April")) {
            text = "4月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("May")) {
            text = "5月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("June")) {
            text = "6月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("July")) {
            text = "7月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("August")) {
            text = "8月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("September")) {
            text = "9月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("October")) {
            text = "10月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("November")) {
            text = "11月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
        if (text.toString().startsWith("December")) {
            text = "12月" + text.toString().substring(text.toString().indexOf(" ") + 1, text.toString().length()) + "日";
        }
            ...
            if (currentMessageObject != null) {
                if (currentMessageObject.messageOwner != null && currentMessageObject.messageOwner.media != null && currentMessageObject.messageOwner.media.ttl_seconds != 0) {
                    if (currentMessageObject.messageOwner.media.photo instanceof TLRPC.TL_photoEmpty) {
                        ...
                        text = currentMessageObject.messageTransfer;
                    }
                } else {
                    text = currentMessageObject.messageTransfer;
                }
