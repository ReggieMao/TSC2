...
import com.ebei.tsc.time.FastDateFormat;
    ...
    public static String formatDateOnline(long date) {
        try {
            ...
            if (dateDay == day && year == dateYear) {
                ...
                String monthAndDay = getInstance().formatterMonth.format(new Date(date));
                switch (monthAndDay.substring(0, 3)) {
                    case "Jan":
                        monthAndDay = "1月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Feb":
                        monthAndDay = "2月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Mar":
                        monthAndDay = "3月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Apr":
                        monthAndDay = "4月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "May":
                        monthAndDay = "5月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Jun":
                        monthAndDay = "6月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Jul":
                        monthAndDay = "7月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Aug":
                        monthAndDay = "8月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Sep":
                        monthAndDay = "9月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Oct":
                        monthAndDay = "10月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Nov":
                        monthAndDay = "11月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                    case "Dec":
                        monthAndDay = "12月" + monthAndDay.substring(4, monthAndDay.length()) + "日";
                        break;
                }
                String format = LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, monthAndDay, getInstance().formatterDay.format(new Date(date)));
        ...
        try {
            ...
            if (Math.abs(System.currentTimeMillis() - date) >= 31536000000L) {
                ...
                if (dayDiff == 0 || dayDiff == -1 && System.currentTimeMillis() - date < 60 * 60 * 8 * 1000) {
                    ...
                    String needWeek = getInstance().formatterWeek.format(new Date(date));
                    switch (needWeek) {
                        case "Mon":
                            needWeek = "周一";
                            break;
                    ...
                    String needMonth = getInstance().formatterMonth.format(new Date(date));
                    switch (needMonth.substring(0, 3)) {
                        case "Jan":
                            needMonth = "1月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Feb":
                            needMonth = "2月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Mar":
                            needMonth = "3月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Apr":
                            needMonth = "4月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "May":
                            needMonth = "5月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Jun":
                            needMonth = "6月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Jul":
                            needMonth = "7月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Aug":
                            needMonth = "8月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Sep":
                            needMonth = "9月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Oct":
                            needMonth = "10月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Nov":
                            needMonth = "11月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                        case "Dec":
                            needMonth = "12月" + needMonth.substring(4, needMonth.length()) + "日";
                            break;
                    }
                    return needMonth;
                }
