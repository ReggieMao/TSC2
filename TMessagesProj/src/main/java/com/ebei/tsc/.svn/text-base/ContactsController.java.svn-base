...
public class ContactsController {
    ...
    public static class Contact {
        ...
        public boolean isGoodProvider() {
            return isGoodProvider;
        }

        public void setGoodProvider(boolean goodProvider) {
            isGoodProvider = goodProvider;
        }
        ...
        public ArrayList<String> getShortPhones() {
            return shortPhones;
        }

        public void setShortPhones(ArrayList<String> shortPhones) {
            this.shortPhones = shortPhones;
        }

        public ArrayList<Integer> getPhoneDeleted() {
            return phoneDeleted;
        }

        public void setPhoneDeleted(ArrayList<Integer> phoneDeleted) {
        ...
        public void setNamesFilled(boolean namesFilled) {
            this.namesFilled = namesFilled;
        }
        ...
        public String toString() {
            return "Contact{" +
                    ...
                    ", key='" + key + '\'' +
                    ", provider='" + provider + '\'' +
                    ", isGoodProvider=" + isGoodProvider +
                    ", phones=" + phones +
                    ", phoneTypes=" + phoneTypes +
                    ", shortPhones=" + shortPhones +
...
//        String link = inviteLink == null ? "https://telegram.org/dl" : inviteLink;
        String link = "http://www.tschain.top";
        if (contacts <= 1) {
    ...
    public void checkAppAccount() {
        ...
        try {
            Account[] accounts = am.getAccountsByType("com.ebei.tsc");
            systemAccount = null;
        ...
        if (UserConfig.getInstance(currentAccount).isClientActivated()) {
            ...
            if (systemAccount == null) {
                try {
                    systemAccount = new Account("" + UserConfig.getInstance(currentAccount).getClientUserId(), "com.ebei.tsc");
        ...
        Utilities.globalQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                /*if (schedule) {
                    try {
                        AccountManager am = AccountManager.get(ApplicationLoader.applicationContext);
                        Account[] accounts = am.getAccountsByType("com.ebei.account");
                        boolean recreateAccount = false;
                        if (UserConfig.getInstance(currentAccount).isClientActivated()) {
                            if (accounts.length != 1) {
                                FileLog.e("detected account deletion!");
                                currentAccount = new Account(UserConfig.getInstance(currentAccount).getCurrentUser().phone, "com.ebei.account");
...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.ebei.tsc.android.profile");
