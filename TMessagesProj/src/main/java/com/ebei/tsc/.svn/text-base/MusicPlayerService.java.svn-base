...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "com.ebei.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "com.ebei.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "com.ebei.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "com.ebei.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "com.ebei.android.musicplayer.next";
