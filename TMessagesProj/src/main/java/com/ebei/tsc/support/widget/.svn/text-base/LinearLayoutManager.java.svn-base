...
import static com.ebei.tsc.support.widget.RecyclerView.VERBOSE_TRACING;
...
import com.ebei.tsc.support.widget.RecyclerView.LayoutParams;
import com.ebei.tsc.support.widget.helper.ItemTouchHelper;
