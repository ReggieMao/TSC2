...
import com.ebei.tsc.support.widget.RecyclerView.LayoutManager;
import com.ebei.tsc.support.widget.RecyclerView.SmoothScroller;
import com.ebei.tsc.support.widget.RecyclerView.SmoothScroller.ScrollVectorProvider;
