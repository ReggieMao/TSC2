...
import com.ebei.tsc.KeepAliveJob;
...
public class ConnectionsManager {
    ...
    public ConnectionsManager(int instance) {
        ...
        Log.d(TAG, "connections info --- deviceModel: " + deviceModel);
        Log.d(TAG, "connections info --- systemLangCode: " + systemLangCode);
        Log.d(TAG, "connections info --- langCode: " + langCode);
        Log.d(TAG, "connections info --- appVersion: " + appVersion);
        Log.d(TAG, "connections info --- systemVersion: " + systemVersion);
